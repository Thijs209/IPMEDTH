...
class TaskSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table->insert([
            ...
            'reports_others' => "Ik rapporteer enkel aan Vera PM voor mijn werkzaamheden.",
        ]);
        ...
        DB::table->insert([
            ...
            'succes' => "Ik heb dit doel bereikt wanneer ik wekelijks minimaal 1 ding aan de juiste afdeling doorspeel wat ik normaal zelf op zou pakken.",
            'manager' => "Mijn manager, Vera PM, kan mij helpen door mij te helpen met het stellen van prioriteiten.",
            'reports_others' => "Ik rapporteer enkel aan Vera PM voor mijn werkzaamheden.",
        ]);
