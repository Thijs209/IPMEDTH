<script>
    ...
    // centeredContent is a prop used by a slot parent to indicate the main content should be centered.
...
<style>
    ...
    /* FIXME Interim fix for width issue */
    .layout-wrapper {
        display: flex;
        flex-direction: row;
    ...
    .main {
        ...
        width: 100%;
        max-width: 100%;
        background-color: #fff; /*TODO remove test bg in production*/
    }
